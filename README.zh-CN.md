...
另在一份 49 页的 NVIDIA GPU 架构白皮书上验证过 —— 完全不同的排版体系(NVIDIASans 而非 Computer Modern、正文 11pt、有页眉、图题写作 `Figure1.` 不带空格、大量位图插图、表格跨页)。自适应不用改任何设置就能处理:12 秒、103 段正文、30 个图题、80 张图(其中 30 张是整幅插图)、3 处跨页拼接、6.5 万字符。
